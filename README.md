...
```
**Standalone macOS binary (Apple silicon, no Python needed to run Genius Dev itself):** `./scripts/build_standalone.sh` builds `dist/standalone/genius/genius`; `packaging/homebrew/genius-dev.rb` is the Homebrew formula (publish steps inside).
